...
const Pattern = Me.imports.lib.yaml.Pattern.Pattern;
const Unescaper = Me.imports.lib.yaml.Unescaper.Unescaper;
const Escaper = Me.imports.lib.yaml.Escaper.Escaper;
const Utils = Me.imports.lib.yaml.Utils.Utils;
const ParseException = Me.imports.lib.yaml.Exception.ParseException.ParseException;
const ParseMore = Me.imports.lib.yaml.Exception.ParseMore.ParseMore;
const DumpException = Me.imports.lib.yaml.Exception.DumpException.DumpException;

var indexOf = [].indexOf;

const Inline = class Inline {
